...
export type ContentItemMetadata = Message<"ContentItemMetadata"> & {
  ...
  /**
   * @generated from field: optional bool isAdvertisement = 98;
   */
  isAdvertisement: boolean;

  /**
   * @generated from field: optional bool hasAlternativeFormats = 99;
   */
  hasAlternativeFormats: boolean;

  /**
   * @generated from field: optional string participantName = 100;
   */
  participantName: string;

  /**
   * @generated from field: optional string participantIdentifier = 101;
   */
  participantIdentifier: string;

  /**
   * @generated from field: optional string classicalWork = 102;
   */
  classicalWork: string;

  /**
   * @generated from field: optional int64 reportingAdamID = 103;
   */
  reportingAdamID: bigint;

  /**
   * @generated from field: optional int64 lyricsAdamID = 104;
   */
  lyricsAdamID: bigint;

  /**
   * @generated from field: optional int64 iTunesStoreAlbumArtistIdentifier = 105;
   */
  iTunesStoreAlbumArtistIdentifier: bigint;

  /**
   * @generated from field: optional string durationStringLocalizationKey = 106;
   */
  durationStringLocalizationKey: string;

  /**
   * @generated from field: optional bool isResolvableParticipant = 107;
   */
  isResolvableParticipant: boolean;

  /**
   * @generated from field: optional string internationalStandardRecordingCode = 108;
   */
  internationalStandardRecordingCode: string;

  /**
   * @generated from field: optional bool isInTransition = 109;
   */
  isInTransition: boolean;

  /**
   * @generated from field: optional bool excludeFromSuggestions = 110;
   */
  excludeFromSuggestions: boolean;

  /**
   * @generated from field: optional bool transcriptAlignmentsAvailable = 111;
   */
  transcriptAlignmentsAvailable: boolean;

  /**
   * @generated from field: optional string subtitleShort = 112;
   */
