...
export const file_DeviceInfoMessage: GenFile = /*@__PURE__*/
  fileDesc("", [file_ProtocolMessage, file_Common]);
...
export type DeviceInfoMessage = Message<"DeviceInfoMessage"> & {
  ...
  /**
   * @generated from field: optional bytes groupSessionToken = 53;
   */
  groupSessionToken: Uint8Array;

  /**
   * @generated from field: optional DeviceInfoMessage leaderDeviceInfo = 54;
   */
  leaderDeviceInfo?: DeviceInfoMessage;

  /**
   * @generated from field: optional bool isClusterLeader = 55;
   */
  isClusterLeader: boolean;

  /**
   * @generated from field: optional string activeSystemEndpointUID = 56;
   */
  activeSystemEndpointUID: string;

  /**
   * @generated from field: optional bool isEligibleForHostingGroupSessionExcludingAcknowledgements = 57;
   */
  isEligibleForHostingGroupSessionExcludingAcknowledgements: boolean;

  /**
   * @generated from field: optional bool parentGroupSupportsGroupCohesion = 58;
   */
  parentGroupSupportsGroupCohesion: boolean;
};
