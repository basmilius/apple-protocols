...
import { embedWebAssets } from './embedWebAssets';
...
// Ensure src/web/embeddedAssets.ts exists before compiling (idempotent — also
// run standalone before tsgo via the build script).
embedWebAssets();
