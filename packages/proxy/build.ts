...
const targets: Target[] = [
    ['ap-proxy-linux-arm64', 'bun-linux-arm64'],
    ['ap-proxy-linux-x64', 'bun-linux-x64'],
    ['ap-proxy-macos-arm64', 'bun-darwin-arm64'],
    ['ap-proxy-macos-x64', 'bun-darwin-x64'],
    ['ap-proxy-windows-x64.exe', 'bun-windows-x64']
];
